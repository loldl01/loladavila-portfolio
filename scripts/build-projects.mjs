...
const backstageImages = backstageFiles.map((file) => `Assets/Images/${backstageFolder}/${file}`);
for (const [index, file] of backstageFiles.entries()) {
  const path = backstageImages[index];
